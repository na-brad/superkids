...
class AddAchievement extends Component {
  ...
  onSubmit(e) {
    ...
    this.props.addAchievement(expData, this.props.history);
  }
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">
                Add any awards or achievements that you are proud of!
              </p>
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextAreaFieldGroup
                  placeholder="Award/Achievement Description"
                  name="description"
                  value={this.state.description}
                  onChange={this.onChange}
                  error={errors.description}
                  info="Tell us about the the achievement"
                />
                <input
                  type="submit"
                  value="Submit"
